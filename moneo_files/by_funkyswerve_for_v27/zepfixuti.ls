...
// Replaces for every item-file in a hak the Palette ID to
// 150+

/*
Use of replace($WhereToReplace, $ValueToSearchFor, $ValueToReplace)
Simply replaces $ValueToSearchFor with $ValueToReplace in $WhereToReplace.
There seem to be more options, I didn't used till yet.
/root = undef;
$matchcase = 0,
$type,
$lang = -1,
